...
public class ManageCustomer extends javax.swing.JFrame {
    ...
    private void showTable()
	{
		int c;
		try{
           String sql="SELECT `CUST_ID`, `CUST_FIRSTNAME`, `CUST_LASTNAME`, `CUST_DOB`, `CUST_GENDER`, `CUST_ADDRESS`, `CUST_AADHARNO`, `CUST_MOBILENO`, `CUST_EMAILID` FROM `customer`";
           PreparedStatement pst =new ConnectDB().getCon().prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cust ID", "First Name", "Last Name", "DOB", "Gender", "Address", "Aadhar No", "Mobile No", "Email Id"
            }
        ));
        ...
        rSMaterialButtonRectangle2.setText("Remove Customer");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(rSMaterialButtonRectangle2, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(186, 186, 186))
        );
...
int n=JOptionPane.showConfirmDialog(this, "Do you To Log out","SMS-Admin",JOptionPane.YES_NO_OPTION);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        cust.setCustFirstName(model.getValueAt(jTable1.getSelectedRow(), 1).toString());
        cust.setCustLastName(model.getValueAt(jTable1.getSelectedRow(), 2).toString());
        cust.setCustDob(model.getValueAt(jTable1.getSelectedRow(), 3).toString());
        cust.setCustGender(model.getValueAt(jTable1.getSelectedRow(), 4).toString());
        cust.setCustAddress(model.getValueAt(jTable1.getSelectedRow(), 5).toString());
        cust.setCustAadharNo(Long.parseLong(model.getValueAt(jTable1.getSelectedRow(), 6).toString()));
        cust.setCustMobileNo(Long.parseLong(model.getValueAt(jTable1.getSelectedRow(), 7).toString()));
        cust.setCustEmail(model.getValueAt(jTable1.getSelectedRow(), 8).toString()); 
        // TODO add your handling code here:
    ...
    private void rSMaterialButtonRectangle2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rSMaterialButtonRectangle2MouseClicked
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        String sql="DELETE FROM `customer` WHERE cust_id=" + (Integer)model.getValueAt(jTable1.getSelectedRow(), 0);
        try{
